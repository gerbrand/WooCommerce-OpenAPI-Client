...
case class ShopOrder (
  ...
  createdVia: Option[String] = None,
  /* Version of WooCommerce which last updated the order. */
  version: Option[Int] = None,
  /* Order status. */
  status: Option[ShopOrderEnums.Status] = None,
  /* Currency the order was created with, in ISO format. */
  currency: Option[ShopOrderEnums.Currency] = None,
  ...
  discountTotal: Option[String] = None,
  /* Total discount tax amount for the order. */
  discountTax: Option[String] = None,
  /* Total shipping amount for the order. */
  shippingTotal: Option[String] = None,
  /* Total shipping tax amount for the order. */
  shippingTax: Option[String] = None,
  /* Sum of line item taxes only. */
  cartTax: Option[String] = None,
  /* Grand total. */
  ...
  customerUserAgent: Option[String] = None,
  ...
  datePaid: Option[String] = None,
  /* The date the order was paid, as GMT. */
  datePaidGmt: Option[String] = None,
  /* The date the order was completed, in the site's timezone. */
  dateCompleted: Option[String] = None,
  /* The date the order was completed, as GMT. */
  dateCompletedGmt: Option[String] = None,
  /* MD5 hash of cart items to ensure orders are not modified. */
  cartHash: Option[String] = None,
  /* Meta data. */
  metaData: Option[Seq[CouponsMetaData]] = None,
  /* Line items data. */
  lineItems: Option[Seq[OrdersLineItems]] = None,
  /* Tax lines data. */
  taxLines: Option[Seq[ShopOrderTaxLines]] = None,
  /* Shipping lines data. */
  ...
  /* List of refunds. */
  refunds: Option[Seq[ShopOrderRefunds]] = None,
  /* Define if the order is paid. It will set the status to processing and reduce stock items. */
  setPaid: Option[Boolean] = None
) extends ApiModel

object ShopOrderEnums {
