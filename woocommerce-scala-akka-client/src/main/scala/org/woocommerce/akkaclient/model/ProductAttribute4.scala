...
case class ProductAttribute4 (
  /* Attribute name. */
  name: Option[String] = None,
  /* An alphanumeric identifier for the resource unique to its type. */
  slug: Option[String] = None,
  /* Type of attribute. */
  `type`: Option[ProductAttribute4Enums.`Type`] = None,
  /* Default sort order. */
  orderBy: Option[ProductAttribute4Enums.OrderBy] = None,
  /* Enable/Disable attribute archives. */
  hasArchives: Option[Boolean] = None
) extends ApiModel

object ProductAttribute4Enums {
