...
case class Batch30 (
  ...
  /* Product type. */
  `type`: Option[Batch30Enums.`Type`] = None,
  /* Product status (post status). */
  status: Option[Batch30Enums.Status] = None,
  /* Featured product. */
  featured: Option[Boolean] = None,
  /* Catalog visibility. */
  catalogVisibility: Option[Batch30Enums.CatalogVisibility] = None,
  /* Product description. */
  ...
  /* Tax status. */
  taxStatus: Option[Batch30Enums.TaxStatus] = None,
  /* Tax class. */
  ...
  stockStatus: Option[Batch30Enums.StockStatus] = None,
  /* If managing stock, this controls if backorders are allowed. */
  backorders: Option[Batch30Enums.Backorders] = None,
