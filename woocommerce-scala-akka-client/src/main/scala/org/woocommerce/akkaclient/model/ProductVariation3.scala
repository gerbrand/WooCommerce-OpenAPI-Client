...
case class ProductVariation3 (
  ...
  /* Variation status. */
  status: Option[ProductVariation3Enums.Status] = None,
  ...
  /* Tax status. */
  taxStatus: Option[ProductVariation3Enums.TaxStatus] = None,
  /* Tax class. */
  ...
  stockStatus: Option[ProductVariation3Enums.StockStatus] = None,
  /* If managing stock, this controls if backorders are allowed. */
  backorders: Option[ProductVariation3Enums.Backorders] = None,
