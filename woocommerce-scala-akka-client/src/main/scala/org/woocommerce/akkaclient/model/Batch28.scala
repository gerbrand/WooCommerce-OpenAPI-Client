...
case class Batch28 (
  ...
  /* Product type. */
  `type`: Option[Batch28Enums.`Type`] = None,
  /* Product status (post status). */
  status: Option[Batch28Enums.Status] = None,
  /* Featured product. */
  featured: Option[Boolean] = None,
  /* Catalog visibility. */
  catalogVisibility: Option[Batch28Enums.CatalogVisibility] = None,
  /* Product description. */
  ...
  /* Tax status. */
  taxStatus: Option[Batch28Enums.TaxStatus] = None,
  /* Tax class. */
  ...
  stockStatus: Option[Batch28Enums.StockStatus] = None,
  /* If managing stock, this controls if backorders are allowed. */
  backorders: Option[Batch28Enums.Backorders] = None,
