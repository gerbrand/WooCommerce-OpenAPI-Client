...
case class ProductVariation (
  ...
  /* Variation status. */
  status: Option[ProductVariationEnums.Status] = None,
  ...
  /* Tax status. */
  taxStatus: Option[ProductVariationEnums.TaxStatus] = None,
  /* Tax class. */
  ...
  stockStatus: Option[ProductVariationEnums.StockStatus] = None,
  /* If managing stock, this controls if backorders are allowed. */
  backorders: Option[ProductVariationEnums.Backorders] = None,
