...
case class ProductVariation1 (
  ...
  /* Variation status. */
  status: Option[ProductVariation1Enums.Status] = None,
  ...
  /* Tax status. */
  taxStatus: Option[ProductVariation1Enums.TaxStatus] = None,
  /* Tax class. */
  ...
  stockStatus: Option[ProductVariation1Enums.StockStatus] = None,
  /* If managing stock, this controls if backorders are allowed. */
  backorders: Option[ProductVariation1Enums.Backorders] = None,
