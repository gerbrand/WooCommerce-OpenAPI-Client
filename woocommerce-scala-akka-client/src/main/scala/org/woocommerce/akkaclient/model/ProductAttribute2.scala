...
case class ProductAttribute2 (
  /* Attribute name. */
  name: Option[String] = None,
  /* An alphanumeric identifier for the resource unique to its type. */
  slug: Option[String] = None,
  /* Type of attribute. */
  `type`: Option[ProductAttribute2Enums.`Type`] = None,
  /* Default sort order. */
  orderBy: Option[ProductAttribute2Enums.OrderBy] = None,
  /* Enable/Disable attribute archives. */
  hasArchives: Option[Boolean] = None
) extends ApiModel

object ProductAttribute2Enums {
