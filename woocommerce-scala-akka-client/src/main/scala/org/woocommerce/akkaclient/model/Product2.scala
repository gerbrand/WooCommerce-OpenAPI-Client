...
case class Product2 (
  ...
  /* Product type. */
  `type`: Option[Product2Enums.`Type`] = None,
  /* Product status (post status). */
  status: Option[Product2Enums.Status] = None,
  /* Featured product. */
  featured: Option[Boolean] = None,
  /* Catalog visibility. */
  catalogVisibility: Option[Product2Enums.CatalogVisibility] = None,
  /* Product description. */
  ...
  /* Tax status. */
  taxStatus: Option[Product2Enums.TaxStatus] = None,
  /* Tax class. */
  ...
  stockStatus: Option[Product2Enums.StockStatus] = None,
  /* If managing stock, this controls if backorders are allowed. */
  backorders: Option[Product2Enums.Backorders] = None,
