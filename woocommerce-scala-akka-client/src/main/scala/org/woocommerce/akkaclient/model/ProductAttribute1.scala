...
case class ProductAttribute1 (
  /* Name for the resource. */
  name: Option[String] = None,
  /* An alphanumeric identifier for the resource unique to its type. */
  slug: Option[String] = None,
  /* Type of attribute. */
  `type`: Option[ProductAttribute1Enums.`Type`] = None,
  /* Default sort order. */
  orderBy: Option[ProductAttribute1Enums.OrderBy] = None,
  /* Enable/Disable attribute archives. */
  hasArchives: Option[Boolean] = None
) extends ApiModel

object ProductAttribute1Enums {
