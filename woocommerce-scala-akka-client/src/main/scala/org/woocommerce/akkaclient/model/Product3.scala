...
case class Product3 (
  ...
  /* Product type. */
  `type`: Option[Product3Enums.`Type`] = None,
  /* Product status (post status). */
  status: Option[Product3Enums.Status] = None,
  /* Featured product. */
  featured: Option[Boolean] = None,
  /* Catalog visibility. */
  catalogVisibility: Option[Product3Enums.CatalogVisibility] = None,
  /* Product description. */
  ...
  /* Tax status. */
  taxStatus: Option[Product3Enums.TaxStatus] = None,
  /* Tax class. */
  ...
  stockStatus: Option[Product3Enums.StockStatus] = None,
  /* If managing stock, this controls if backorders are allowed. */
  backorders: Option[Product3Enums.Backorders] = None,
