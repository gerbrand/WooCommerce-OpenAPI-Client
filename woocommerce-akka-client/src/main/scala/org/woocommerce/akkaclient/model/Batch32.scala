...
case class Batch32 (
  ...
  /* Variation status. */
  status: Option[Batch32Enums.Status] = None,
  ...
  /* Tax status. */
  taxStatus: Option[Batch32Enums.TaxStatus] = None,
  /* Tax class. */
  ...
  stockStatus: Option[Batch32Enums.StockStatus] = None,
  /* If managing stock, this controls if backorders are allowed. */
  backorders: Option[Batch32Enums.Backorders] = None,
