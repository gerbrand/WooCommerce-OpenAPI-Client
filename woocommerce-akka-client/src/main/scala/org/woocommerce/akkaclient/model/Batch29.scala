...
case class Batch29 (
  ...
  /* Product type. */
  `type`: Option[Batch29Enums.`Type`] = None,
  /* Product status (post status). */
  status: Option[Batch29Enums.Status] = None,
  /* Featured product. */
  featured: Option[Boolean] = None,
  /* Catalog visibility. */
  catalogVisibility: Option[Batch29Enums.CatalogVisibility] = None,
  /* Product description. */
  ...
  /* Tax status. */
  taxStatus: Option[Batch29Enums.TaxStatus] = None,
  /* Tax class. */
  ...
  stockStatus: Option[Batch29Enums.StockStatus] = None,
  /* If managing stock, this controls if backorders are allowed. */
  backorders: Option[Batch29Enums.Backorders] = None,
