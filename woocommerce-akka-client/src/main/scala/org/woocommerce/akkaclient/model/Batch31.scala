...
case class Batch31 (
  ...
  /* Variation status. */
  status: Option[Batch31Enums.Status] = None,
  ...
  /* Tax status. */
  taxStatus: Option[Batch31Enums.TaxStatus] = None,
  /* Tax class. */
  ...
  stockStatus: Option[Batch31Enums.StockStatus] = None,
  /* If managing stock, this controls if backorders are allowed. */
  backorders: Option[Batch31Enums.Backorders] = None,
