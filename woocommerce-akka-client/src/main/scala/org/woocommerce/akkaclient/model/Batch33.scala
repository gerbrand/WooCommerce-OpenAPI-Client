...
case class Batch33 (
  ...
  /* Variation status. */
  status: Option[Batch33Enums.Status] = None,
  ...
  /* Tax status. */
  taxStatus: Option[Batch33Enums.TaxStatus] = None,
  /* Tax class. */
  ...
  stockStatus: Option[Batch33Enums.StockStatus] = None,
  /* If managing stock, this controls if backorders are allowed. */
  backorders: Option[Batch33Enums.Backorders] = None,
