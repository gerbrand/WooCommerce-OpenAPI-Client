...
case class CartPrices (
  ...
  /* Ruwe, onafgeronde productprijzen die in berekeningen worden gebruikt. Aangegeven met een hogere nauwkeurigheidseenheid dan de valuta. */
  rawPrices: Option[Any] = None
) extends ApiModel
