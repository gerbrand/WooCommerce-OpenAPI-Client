...
case class ProductVariation2 (
  ...
  /* Variation status. */
  status: Option[ProductVariation2Enums.Status] = None,
  ...
  /* Tax status. */
  taxStatus: Option[ProductVariation2Enums.TaxStatus] = None,
  /* Tax class. */
  ...
  stockStatus: Option[ProductVariation2Enums.StockStatus] = None,
  /* If managing stock, this controls if backorders are allowed. */
  backorders: Option[ProductVariation2Enums.Backorders] = None,
