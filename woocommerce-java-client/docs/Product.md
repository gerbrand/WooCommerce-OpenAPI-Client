...
**dateModified** | **String** | The date the product was last modified, in the site&#39;s timezone. |  [optional]
**dateModifiedGmt** | **String** | The date the product was last modified, as GMT. |  [optional]
