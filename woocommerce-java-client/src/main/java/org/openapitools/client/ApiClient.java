...
public class ApiClient {
    ...
    private String basePath = "https://www.software-creation.nl/wp-json/wc/v3";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://www.software-creation.nl/wp-json/wc/v3
