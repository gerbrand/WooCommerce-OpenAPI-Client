...
public class PaymentGateway2 {
  ...
  public PaymentGateway2 title(String title) {
  ...
  **/
  ...
  public PaymentGateway2 description(String description) {
  ...
  **/
  ...
  public PaymentGateway2 order(Integer order) {
  ...
  **/
  ...
  public PaymentGateway2 enabled(Boolean enabled) {
  ...
  **/
  ...
  public PaymentGateway2 settings(PaymentGatewaysIdSettings settings) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PaymentGateway2 paymentGateway2 = (PaymentGateway2) o;
    return Objects.equals(this.title, paymentGateway2.title) &&
        Objects.equals(this.description, paymentGateway2.description) &&
        Objects.equals(this.order, paymentGateway2.order) &&
        Objects.equals(this.enabled, paymentGateway2.enabled) &&
        Objects.equals(this.settings, paymentGateway2.settings);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentGateway2 {\n");
