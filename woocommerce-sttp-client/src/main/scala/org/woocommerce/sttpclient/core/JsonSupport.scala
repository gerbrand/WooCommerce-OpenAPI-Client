...
import org.woocommerce.sttpclient.model._
import org.json4s._
...
object JsonSupport extends SttpJson4sApi {
  def enumSerializers: Seq[Serializer[_]] = Seq[Serializer[_]]() :+
    new EnumNameSerializer(AttributesEnums.Operator) :+
    new EnumNameSerializer(CalculateAttributeCountsEnums.QueryType) :+
    new EnumNameSerializer(CheckoutEnums.PaymentMethod) :+
    new EnumNameSerializer(RequestsEnums.Method)
